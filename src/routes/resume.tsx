export default function Resume() {
  ...
  return (
    <main class="flex flex-col items-center mx-auto text-left text-gray-700 space-y-4 p-6 md:w-3xl">
      ...
      <p class="mt-8">
        Python web software developer with {webYears}+ years experience in
      ...
      <table class="text-left border-separate">
        <tbody>
          ...
          <tr class="align-text-top">
            <th>Python</th>
            <td>
              {python_years}+ years; Plone, Django, Pyramid, Flask, Zope, Grok
            </td>
          </tr>
          <tr class="align-text-top">
            <th>Frontend</th>
            <td>Typescript, Javascript, React, SolidJS, Angular</td>
          </tr>
          <tr class="align-text-top">
            <th>Backend</th>
